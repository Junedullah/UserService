...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			.csrf().disable()
			.authorizeRequests()
			.antMatchers("/***","/fieldcustomization/**","/login/**","/group/**","/user/**","/company/**","/authSettings/**", "/ip/**","/plugUnplugServices/**","/language/**","/department/**","/division/**","/hrCity/**", "/workFlowAssign/**","/fields/**", "/comon/**", "/grids/**","/reportmaster/**","/companyreport/**","/module/**","/grid/**","/gridData/**"/*,"http://10.0.0.244:8080/activiti-app/**"*/).permitAll()
